...
const ElectronicsPortfolio = () => {
  ...
  //       <p>© 2025 Crystal Solutions | Electronics Mangement System</p>
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 font-sans">
      ...
      <section className="py-24 text-center bg-white">
        <h1 className="text-5xl font-extrabold">Electronics Management System</h1>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-14 text-slate-900">
            Everything Your Electronics Software Needs — In One Place
          </h2>
      ...
      <section className="py-28 bg-gradient-to-r from-blue-900 to-slate-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mt-6 text-xl text-gray-300">
            Contact us today to upgrade your electronics with our powerful app.
          </p>
      ...
      <footer className="py-8 text-center text-gray-400 bg-white border-t border-gray-200">
        © 2025 Crystal Solutions | Electronics Mangement System <br />
        crystalsupport@gmail.com
      </footer>
    </div>
  );
};

export default ElectronicsPortfolio;
